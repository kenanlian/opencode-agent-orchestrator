...
describe("getPlatformPackage", () => {
  ...
  test("returns darwin-arm64 for macOS ARM64", () => {
    ...
    expect(result).toBe("@kenanlian/opencode-agent-orchestrator-darwin-arm64");
  });
  ...
  test("returns darwin-x64 for macOS Intel", () => {
    ...
    // #then returns correct package name
    expect(result).toBe("@kenanlian/opencode-agent-orchestrator-darwin-x64");
  });
  // #endregion
  ...
  test("returns linux-x64 for Linux x64 with glibc", () => {
    ...
    // #then returns correct package name
    expect(result).toBe("@kenanlian/opencode-agent-orchestrator-linux-x64");
  });
  ...
  test("returns linux-arm64 for Linux ARM64 with glibc", () => {
    ...
    // #then returns correct package name
    expect(result).toBe("@kenanlian/opencode-agent-orchestrator-linux-arm64");
  });
  // #endregion
  ...
  test("returns linux-x64-musl for Alpine x64", () => {
    ...
    expect(result).toBe("@kenanlian/opencode-agent-orchestrator-linux-x64-musl");
  });
  ...
  test("returns linux-arm64-musl for Alpine ARM64", () => {
    ...
    // #then returns correct package name with musl suffix
    expect(result).toBe("@kenanlian/opencode-agent-orchestrator-linux-arm64-musl");
  });
  // #endregion
  ...
  test("returns windows-x64 for Windows", () => {
    ...
    expect(result).toBe("@kenanlian/opencode-agent-orchestrator-windows-x64");
  });
  // #endregion
...
describe("getBinaryPath", () => {
  test("returns path without .exe for Unix platforms", () => {
    ...
    const pkg = "@kenanlian/opencode-agent-orchestrator-darwin-arm64";
    ...
    expect(result).toBe("@kenanlian/opencode-agent-orchestrator-darwin-arm64/bin/opencode-agent-orchestrator");
  });

  test("returns path with .exe for Windows", () => {
    // #given Windows platform package
    const pkg = "@kenanlian/opencode-agent-orchestrator-windows-x64";
    ...
    expect(result).toBe("@kenanlian/opencode-agent-orchestrator-windows-x64/bin/opencode-agent-orchestrator.exe");
  });

  test("returns path without .exe for Linux", () => {
    // #given Linux platform package
    const pkg = "@kenanlian/opencode-agent-orchestrator-linux-x64";
    ...
    // #then returns path without extension
    expect(result).toBe("@kenanlian/opencode-agent-orchestrator-linux-x64/bin/opencode-agent-orchestrator");
  });
});
...
describe("getPlatformPackageCandidates", () => {
  test("returns x64 and baseline candidates for Linux glibc", () => {
    ...
    expect(result).toEqual([
      "@kenanlian/opencode-agent-orchestrator-linux-x64",
      "@kenanlian/opencode-agent-orchestrator-linux-x64-baseline",
    ]);
  });
  ...
  test("returns x64 musl and baseline candidates for Linux musl", () => {
    ...
    expect(result).toEqual([
      "@kenanlian/opencode-agent-orchestrator-linux-x64-musl",
      "@kenanlian/opencode-agent-orchestrator-linux-x64-musl-baseline",
    ]);
  });
  ...
  test("returns baseline first when preferBaseline is true", () => {
    ...
    expect(result).toEqual([
      "@kenanlian/opencode-agent-orchestrator-windows-x64-baseline",
      "@kenanlian/opencode-agent-orchestrator-windows-x64",
    ]);
  });
  ...
  test("supports renamed package family via packageBaseName override", () => {
    // #given Linux x64 with glibc and renamed package base
      const input = { platform: "linux", arch: "x64", libcFamily: "glibc", packageBaseName: "@kenanlian/opencode-agent-orchestrator" };
  ...
  test("returns only one candidate for ARM64", () => {
    ...
    expect(result).toEqual(["@kenanlian/opencode-agent-orchestrator-linux-arm64"]);
  });
});
