...
import type { OpenCodeAgentOrchestratorConfig } from "../../config/schema"

export function getTaskDir(config: Partial<OpenCodeAgentOrchestratorConfig> = {}): string {
...
export function resolveTaskListId(config: Partial<OpenCodeAgentOrchestratorConfig> = {}): string {
...
export function listTaskFiles(config: Partial<OpenCodeAgentOrchestratorConfig> = {}): string[] {
