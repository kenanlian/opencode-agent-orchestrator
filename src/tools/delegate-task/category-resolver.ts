...
2. Or configure an alternative model in your opencode-agent-orchestrator.json for this category
...
2. OpenCode Agent Orchestrator: Set category model in opencode-agent-orchestrator.json
