...
export function createOracleAgent(model: string): AgentConfig {
  ...
  const base = {
    description:
      "Read-only consultation agent. High-IQ reasoning specialist for debugging hard problems and high-difficulty architecture design. (Oracle - OpenCode Agent Orchestrator)",
    mode: MODE,
    model,
    temperature: 0.1,
    ...restrictions,
