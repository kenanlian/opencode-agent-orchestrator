...
| File | Purpose |
|------|---------|
| `index.ts` | Plugin entry, exports `OpenCodeAgentOrchestratorPlugin` |
...
loadPluginConfig(directory, ctx)
  1. User: ~/.config/opencode/opencode-agent-orchestrator.jsonc
  2. Project: .opencode/opencode-agent-orchestrator.jsonc
