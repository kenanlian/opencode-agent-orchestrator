...
Cross-cutting utilities used throughout the plugin. Barrel-exported from `index.ts`. Logger writes to `/tmp/opencode-agent-orchestrator.log`.
...
|---------|-------------|---------|
| `logger.ts` | 62 | `/tmp/opencode-agent-orchestrator.log` |
