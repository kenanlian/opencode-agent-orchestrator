/**
 * Unified system directive prefix for OpenCode Agent Orchestrator internal messages.
 * All system-generated messages should use this prefix for consistent filtering.
 *
 * Format: [SYSTEM DIRECTIVE: OPENCODE-AGENT-ORCHESTRATOR - {TYPE}]
 */

export const SYSTEM_DIRECTIVE_PREFIX = "[SYSTEM DIRECTIVE: OPENCODE-AGENT-ORCHESTRATOR"

/**
 * Creates a system directive header with the given type.
 * @param type - The directive type (e.g., "TODO CONTINUATION", "RALPH LOOP")
 * @returns Formatted directive string like "[SYSTEM DIRECTIVE: OPENCODE-AGENT-ORCHESTRATOR - TODO CONTINUATION]"
 */
...
/**
 * Checks if a message starts with the OpenCode Agent Orchestrator system directive prefix.
