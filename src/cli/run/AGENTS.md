...
37 files. Powers the `opencode-agent-orchestrator run <message>` command. Connects to OpenCode server, creates/resumes sessions, streams events, and polls for completion.
