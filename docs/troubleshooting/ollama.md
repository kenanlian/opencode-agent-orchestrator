...
When using Ollama as a provider with OpenCode Agent Orchestrator agents, you may encounter:
...
- **OpenCode Agent Orchestrator**: Passes through the SDK's behavior (can't fix at this layer)
...
**Tracking**: https://github.com/kenanlian/opencode-agent-orchestrator/issues/1124
...
- **OpenCode Agent Orchestrator**: https://github.com/kenanlian/opencode-agent-orchestrator/issues/1124
